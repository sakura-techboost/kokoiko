          ...
          <div class="card-body">
            <form method="POST" action="{{ route('register') }}">
              ...
              <div class="form-group row">
                <label class="col-lg-3 col-form-label text-lg-right" for="name">名前</label>
                <div class="col-lg-5">
              ...
              {{-- ふりがな入力欄 --}}
              <div class="form-group row">
                <label class="col-lg-3 col-form-label text-lg-right" for="kana">ふりがな</label>
                <div class="col-lg-5">
              ...
              {{-- ニックネーム入力欄 --}}
              <div class="form-group row">
                <label class="col-lg-3 col-form-label text-lg-right" for="nickname">ニックネーム(表示名)</label>
                <div class="col-lg-5">
              ...
              {{-- パスワード確認入力欄 --}}
              <div class="form-group row">
                <label class="col-lg-3 col-form-label text-lg-right" for="password-confirm">パスワード再入力</label>
                <div class="col-lg-5">
